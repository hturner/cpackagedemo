...
{
    // could also check lengths here (or should do in R), assuming length(x) = length(f), n>0
    // must check here if C code is part of R API, to ensure safe for others to use
